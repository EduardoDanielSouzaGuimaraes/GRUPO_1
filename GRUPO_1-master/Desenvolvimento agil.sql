...
CREATE TABLE IF NOT EXISTS `desenvolagil`.`usuario` (
  ...
  `Dt_Insc` VARCHAR(10) NOT NULL,
  `Dt_Ult_Login` VARCHAR(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `desenvolagil`.`emprestimo` (
  ...
  `DataDevoucao` VARCHAR(10) NOT NULL,
...
-- -----------------------------------------------------
-- Table `desenvolagil`.`multa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `desenvolagil`.`multa` (
  `ValorMulta` VARCHAR(10) NOT NULL,
  `emprestimo_DataEmprestimo` VARCHAR(10) NOT NULL,
  `emprestimo_DataDevoucao` VARCHAR(10) NOT NULL,
  INDEX `fk_multa_emprestimo1_idx` (`emprestimo_DataEmprestimo` ASC, `emprestimo_DataDevoucao` ASC) VISIBLE,
  CONSTRAINT `fk_multa_emprestimo1`
    FOREIGN KEY (`emprestimo_DataEmprestimo` , `emprestimo_DataDevoucao`)
    REFERENCES `desenvolagil`.`emprestimo` (`DataEmprestimo` , `DataDevoucao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
